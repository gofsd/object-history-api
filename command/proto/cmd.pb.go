...
const file_proto_cmd_cmd_proto_rawDesc = "" +
	...
	"\bcommands\x18\x01 \x03(\v2\x10.command.CommandR\bcommands\"&\n" +
	...
	"\x05ADMIN\x10\x022\x89\t\n" +
	"\x0eCommandService\x125\n" +
	"\n" +
	"ListGroups\x12\x0e.command.Empty\x1a\x17.command.GroupsResponse\x12*\n" +
	"\bAddGroup\x12\x0e.command.Group\x1a\x0e.command.Group\x124\n" +
	...
	"\x13RemoveUserFromGroup\x12\x19.command.UserGroupRequest\x1a\x1a.command.UserGroupResponse\x129\n" +
	"\fListCommands\x12\x0e.command.Empty\x1a\x19.command.CommandsResponse\x12:\n" +
	"\n" +
	"AddCommand\x12\x1a.command.AddCommandRequest\x1a\x10.command.Command\x12@\n" +
	"\rDeleteCommand\x12\x1d.command.DeleteCommandRequest\x1a\x10.command.Command\x12J\n" +
	"\x11AddCommandToGroup\x12\x19.command.UserGroupRequest\x1a\x1a.command.UserGroupResponse\x12O\n" +
	"\x16DeleteCommandFromGroup\x12\x19.command.UserGroupRequest\x1a\x1a.command.UserGroupResponse\x12<\n" +
...
var file_proto_cmd_cmd_proto_goTypes = []any{
	...
	(*CommandsResponse)(nil),              // 9: command.CommandsResponse
	(*DeleteCommandRequest)(nil),          // 10: command.DeleteCommandRequest
	(*ExecuteRequest)(nil),                // 11: command.ExecuteRequest
	(*ExecuteResponse)(nil),               // 12: command.ExecuteResponse
	(*CancelRequest)(nil),                 // 13: command.CancelRequest
	(*CancelResponse)(nil),                // 14: command.CancelResponse
	(*RetryRequest)(nil),                  // 15: command.RetryRequest
	(*DryRunResult)(nil),                  // 16: command.DryRunResult
	(*SubscribeRequest)(nil),              // 17: command.SubscribeRequest
	(*CommandLog)(nil),                    // 18: command.CommandLog
	(*UpdateExecutionStatusRequest)(nil),  // 19: command.UpdateExecutionStatusRequest
	(*UpdateExecutionStatusResponse)(nil), // 20: command.UpdateExecutionStatusResponse
	(*SubscribeCommandEventsRequest)(nil), // 21: command.SubscribeCommandEventsRequest
	(*CommandEvent)(nil),                  // 22: command.CommandEvent
	(*Object)(nil),                        // 23: command.Object
	(*UserGroupResponse)(nil),             // 24: command.UserGroupResponse
	(*Empty)(nil),                         // 25: command.Empty
	nil,                                   // 26: command.ExecuteRequest.OverrideParametersEntry
	nil,                                   // 27: command.CommandLog.EffectiveParametersEntry
	nil,                                   // 28: command.CommandEvent.EffectiveParametersEntry
	nil,                                   // 29: command.Object.FieldsEntry
}
var file_proto_cmd_cmd_proto_depIdxs = []int32{
	...
	7,  // 4: command.CommandsResponse.commands:type_name -> command.Command
	26, // 5: command.ExecuteRequest.override_parameters:type_name -> command.ExecuteRequest.OverrideParametersEntry
	0,  // 6: command.ExecuteResponse.queue_status:type_name -> command.ExecutionStatus
	0,  // 7: command.CommandLog.status:type_name -> command.ExecutionStatus
	27, // 8: command.CommandLog.effective_parameters:type_name -> command.CommandLog.EffectiveParametersEntry
	0,  // 9: command.UpdateExecutionStatusRequest.status:type_name -> command.ExecutionStatus
	28, // 10: command.CommandEvent.effective_parameters:type_name -> command.CommandEvent.EffectiveParametersEntry
	29, // 11: command.Object.fields:type_name -> command.Object.FieldsEntry
	1,  // 12: command.UserGroupResponse.role:type_name -> command.UserRole
	25, // 13: command.CommandService.ListGroups:input_type -> command.Empty
	2,  // 14: command.CommandService.AddGroup:input_type -> command.Group
	4,  // 15: command.CommandService.DeleteGroup:input_type -> command.GroupRequest
	5,  // 16: command.CommandService.AddUserToGroup:input_type -> command.UserGroupRequest
	5,  // 17: command.CommandService.RemoveUserFromGroup:input_type -> command.UserGroupRequest
	25, // 18: command.CommandService.ListCommands:input_type -> command.Empty
	8,  // 19: command.CommandService.AddCommand:input_type -> command.AddCommandRequest
	10, // 20: command.CommandService.DeleteCommand:input_type -> command.DeleteCommandRequest
	5,  // 21: command.CommandService.AddCommandToGroup:input_type -> command.UserGroupRequest
	5,  // 22: command.CommandService.DeleteCommandFromGroup:input_type -> command.UserGroupRequest
	11, // 23: command.CommandService.Execute:input_type -> command.ExecuteRequest
	13, // 24: command.CommandService.Cancel:input_type -> command.CancelRequest
	15, // 25: command.CommandService.Retry:input_type -> command.RetryRequest
	11, // 26: command.CommandService.DryRun:input_type -> command.ExecuteRequest
	19, // 27: command.CommandService.UpdateExecutionStatus:input_type -> command.UpdateExecutionStatusRequest
	17, // 28: command.CommandService.SubscribeLogs:input_type -> command.SubscribeRequest
	21, // 29: command.CommandService.SubscribeCommandEvents:input_type -> command.SubscribeCommandEventsRequest
	3,  // 30: command.CommandService.ListGroups:output_type -> command.GroupsResponse
	2,  // 31: command.CommandService.AddGroup:output_type -> command.Group
	2,  // 32: command.CommandService.DeleteGroup:output_type -> command.Group
	24, // 33: command.CommandService.AddUserToGroup:output_type -> command.UserGroupResponse
	24, // 34: command.CommandService.RemoveUserFromGroup:output_type -> command.UserGroupResponse
	9,  // 35: command.CommandService.ListCommands:output_type -> command.CommandsResponse
	7,  // 36: command.CommandService.AddCommand:output_type -> command.Command
	7,  // 37: command.CommandService.DeleteCommand:output_type -> command.Command
	24, // 38: command.CommandService.AddCommandToGroup:output_type -> command.UserGroupResponse
	24, // 39: command.CommandService.DeleteCommandFromGroup:output_type -> command.UserGroupResponse
	12, // 40: command.CommandService.Execute:output_type -> command.ExecuteResponse
	14, // 41: command.CommandService.Cancel:output_type -> command.CancelResponse
	12, // 42: command.CommandService.Retry:output_type -> command.ExecuteResponse
	16, // 43: command.CommandService.DryRun:output_type -> command.DryRunResult
	20, // 44: command.CommandService.UpdateExecutionStatus:output_type -> command.UpdateExecutionStatusResponse
	18, // 45: command.CommandService.SubscribeLogs:output_type -> command.CommandLog
	22, // 46: command.CommandService.SubscribeCommandEvents:output_type -> command.CommandEvent
